...
export default function Navbar() {
  ...
  const scrollTo = (id) => {
    const sectionMap = {
      ...
      certificates: document.querySelector("section:nth-of-type(6)")?.offsetTop,
      contact: document.querySelector("section:nth-of-type(7)")?.offsetTop,
    };
                ...
                {[
                  ...
                  <motion.button
                    ...
                    onClick={() => {
                      setResumeOpen(false);
                      if (action === "view") {
                        window.open("https://drive.google.com/file/d/1qFIG7tjYG5GZqxffBrIPj0tyZxM8XscB/view?usp=sharing", "_blank");
                      } else {
                        const a = document.createElement("a");
                        a.href = "https://drive.google.com/uc?export=download&id=1qFIG7tjYG5GZqxffBrIPj0tyZxM8XscB";
                        a.click();
                      }
                    }}

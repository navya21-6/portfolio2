  ...
  return (
    <section ref={ref} style={{
      ...
      <motion.div style={{ x: xLeft }}>
        ...
        >
          Computer Science student obsessed with problem-solving, algorithms, and data-driven systems.
        </div>
      </motion.div>
      ...
      <motion.div style={{ x: xRight }}>
        ...
        <div ref={rowsRef} style={{ marginTop: 32 }}>
          {[
            ...
            ["GRAD YEAR",  "2027"],
            ["STACK",      "C++ · Python · Java · MySQL"],
            ["FOCUS",      "Data Structures · Algorithms · Analysis"],
          ].map(([k, v]) => (
            <div
              key={k}
              className="about-row"

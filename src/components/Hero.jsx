  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div>
          {[
            { text: "BUILD.",   color: C.white,      stroke: false, delay: 0.35 },
            { text: "ANIMATE.", color: "transparent", stroke: true,  delay: 0.5  },
            { text: "SHIP.",    color: C.neon,        stroke: false, delay: 0.65 },
          ].map(({ text, color, stroke, delay }) => (
            <div key={text} style={{ overflow: "hidden", marginBottom: text === "SHIP." ? 40 : 16 }}>
              <motion.h1
                className="bebas"
          ...
          >
            <MagneticBtn>VIEW WORK</MagneticBtn>

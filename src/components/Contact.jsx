  ...
  const socials = [
    {
      ...
      href: "https://github.com/navya21-6",
    },
    {
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      href: "https://www.linkedin.com/in/navya-angajala",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          <div ref={emailRef}>
            <MagLink
              href="mailto:navyaangajala123@gmail.com"
              isEmail
              icon={
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              label={'sendEmail("navyaangajala123@gmail.com")'}
            />
          </div>
        </div>
      </div>

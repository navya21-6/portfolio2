...
const techItems = [
  "C++", "PYTHON", "JAVA", "MYSQL", "PANDAS",
  "NUMPY", "MATPLOTLIB", "HTML/CSS", "POWER BI", "JUPYTER",
  "GIT", "GITHUB", "SFML", "DATA STRUCTURES", "ALGORITHMS",
];

const ROWS = [
  { items: techItems.slice(0, 8),  dir:  1, speed: 0.55 },
  { items: techItems.slice(4, 12), dir: -1, speed: 0.45 },
  { items: techItems.slice(7),     dir:  1, speed: 0.65 },
];
          ...
          return (
            <span key={i} style={{ display: "inline-flex", alignItems: "center", flexShrink: 0 }}>
              ...
              <span style={{
                ...
                width: 7, height: 7,
                border: `1px solid ${col === "neon" ? C.neon : "#222"}`,
